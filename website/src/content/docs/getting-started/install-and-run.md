...
1. Download [Keyper.Setup.v1.3.3-win-x64.exe](https://pub-da847cd0fc1045b3a5a7fcc39a3be134.r2.dev/Keyper.Setup.v1.3.3-win-x64.exe).
...
```bash
chmod +x Keyper-1.3.3-x86_64.AppImage
./Keyper-1.3.3-x86_64.AppImage
```

**Linux .deb quick start:**

```bash
sudo dpkg -i keyper_1.3.3_amd64.deb
